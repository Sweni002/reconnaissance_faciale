...
bool _obscureText = true;
  ...
  icon: Icon(
    _obscureText ? Icons.remove_red_eye_rounded : Icons.visibility_off_rounded,
    size: 27,
    color: const Color.fromARGB(255, 58, 85, 121),
  ),
),
         ),
                              ),
  ...
  child: Wrap(
    ...
    spacing: 5, // espace horizontal entre les enfants
    children: [
      const Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton.icon(
                                  onPressed: () {
                                    Navigator.pop(context);
                                    Navigator.pushNamed(context, '/sortie');
                                  },
                                  icon: const Icon(
